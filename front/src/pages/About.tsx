  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
      <div className="text-center mb-12">
        <h1 className="text-3xl font-bold text-gray-900 sm:text-4xl">Sobre Piel Sana IA</h1>
        ...
        <div>
          ...
          <ol className="space-y-4">
            <li className="flex">
              ...
              <div>
                <p className="text-gray-600">
                  <span className="font-medium text-gray-900">Sube una foto</span> - Captura claramente el área de la piel que te preocupa.
                </p>
              </div>
            </li>
            <li className="flex">
              ...
              <div>
                <p className="text-gray-600">
                  <span className="font-medium text-gray-900">Procesamiento por IA</span> - Nuestro algoritmo analiza la imagen buscando patrones característicos de condiciones dermatológicas comunes.
                </p>
              </div>
            </li>
            <li className="flex">
              ...
              <div>
                <p className="text-gray-600">
                  <span className="font-medium text-gray-900">Recibe resultados</span> - Obtendrás un informe con posibles condiciones identificadas y su probabilidad.
                </p>
              </div>
            </li>
            <li className="flex">
              ...
              <div>
                <p className="text-gray-600">
                  <span className="font-medium text-gray-900">Recomendaciones</span> - Te proporcionamos información educativa y sugerencias para el cuidado, pero siempre recomendamos la consulta con especialistas.
                </p>
              </div>
            </li>
          </ol>
      ...
      <div className="bg-gray-50 rounded-lg p-8 border border-gray-200">
        ...
        <div className="space-y-6 max-w-3xl mx-auto">
          <div>
            <h3 className="text-lg font-medium text-gray-900 mb-2">¿Es Piel Sana IA un reemplazo para la consulta médica?</h3>
            <p className="text-gray-600">
          ...
          <div>
            <h3 className="text-lg font-medium text-gray-900 mb-2">¿Qué tan preciso es el análisis?</h3>
            <p className="text-gray-600">
          ...
          <div>
            <h3 className="text-lg font-medium text-gray-900 mb-2">¿Cómo se protege mi privacidad?</h3>
            <p className="text-gray-600">
          ...
          <div>
            <h3 className="text-lg font-medium text-gray-900 mb-2">¿Qué debo hacer después de recibir mi análisis?</h3>
            <p className="text-gray-600">
